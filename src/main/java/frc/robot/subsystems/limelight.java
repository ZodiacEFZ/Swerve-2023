...
public class Limelight extends SubsystemBase {
    ...
    public void periodic() {
        ...
        trackingStatus = (NetworkTableInstance.getDefault().getTable("limelight").getEntry("tv").getDouble(0) == 1
                ? true
                : false);
        ...
        try {
             ...
             * if you have to update this, remember to make the corresponding object public
             * in the code
             * or we may contribute to the source code on the github, under this condition
        ...
        } catch (Exception e) { // using "try...catch..." to avoid tracking the null pointer (this will cause
